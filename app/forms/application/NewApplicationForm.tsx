  ...
  return (
    <div className="min-h-screen bg-[#0A0F1E]">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSI0MCIgaGVpZ2h0PSI0MCIgdmlld0JveD0iMCAwIDQwIDQwIj48cGF0aCBkPSJNMjAgMjBoMjB2MjBIMjB6TTAgMGgyMHYyMEgweiIgZmlsbD0icmdiYSgyNTUsMjU1LDI1NSwwLjAyKSIvPjwvc3ZnPg==')] opacity-20"></div>
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        <div className="mb-10 md:mb-16">
          <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-6">
              ...
              <div className="flex items-center gap-4">
                <div className="relative mt-7">
                  <div className="w-14 h-14 bg-gradient-to-tr from-indigo-500 to-blue-500 rounded-xl shadow-lg shadow-indigo-500/20 flex items-center justify-center">
                    <div className="w-3 h-8 bg-white/90 rounded-full"></div>
                  </div>
                ...
                <div className="mt-10">
                  ...
                  <p className="text-slate-400 mt-2 font-light">
                    Premium driving school enrollment
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              <div className="hidden md:flex mt-9 items-center gap-3 px-5 py-3 bg-slate-800/60 backdrop-blur-sm rounded-xl shadow-sm border border-slate-700/50">
                <div className="relative">
                  <div className="w-2 h-2 bg-emerald-500 rounded-full"></div>
                  <div className="absolute -inset-1 bg-emerald-500/20 blur-sm rounded-full"></div>
                </div>
        ...
        {/* Form Container */}
        <div className="relative">
          <div className="absolute top-0 left-8 right-8 h-px bg-gradient-to-r from-transparent via-indigo-500/20 to-transparent"></div>

          <div className="bg-slate-800/40 backdrop-blur-sm rounded-2xl shadow-2xl border border-slate-700/50 overflow-hidden">
            {/* Form Header */}
            <div className="px-8 py-6 border-b border-slate-700/50 bg-slate-800/80 relative">
              ...
              <div className="flex items-center justify-between pt-2">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-400">Complete all sections carefully</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-indigo-500 rounded-full"></div>
                  <span className="text-sm font-medium text-slate-300">Step 1/1</span>
                </div>
              </div>
            </div>
            ...
            <form onSubmit={onSubmit} className="p-8 md:p-10">
              <div className="space-y-12">
                {/* Section 1: Personal Information */}
                <div className="space-y-8">
                  <SectionHeader number="01" title="Personal Information" subtitle="Basic student details" />
                  ...
                  <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                    <FieldBlock label="Full Name" required>
                      <Input
                        name="fullName"
                        required
                        className="bg-slate-900/50 border-slate-700 text-white placeholder-slate-500 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 h-12 rounded-xl transition-all duration-300"
                        placeholder="Enter full legal name"
                      />
                    </FieldBlock>

                    <FieldBlock label="NIC Number" required>
                      <Input
                        name="nic"
                        required
                        className="bg-slate-900/50 border-slate-700 text-white placeholder-slate-500 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 h-12 rounded-xl transition-all duration-300"
                    ...
                    <FieldBlock label="Date of Birth" required className="md:col-span-2 lg:col-span-1">
                      <Input
                        name="dob"
                        type="date"
                        required
                        className="bg-slate-900/50 border-slate-700 text-white focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 h-12 rounded-xl transition-all duration-300"
                      />
                    </FieldBlock>

                    <FieldBlock label="Address" required className="md:col-span-3">
                      <Textarea
                        name="address"
                        required
                        className="bg-slate-900/50 border-slate-700 text-white placeholder-slate-500 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 min-h-[100px] rounded-xl transition-all duration-300"
                        placeholder="Complete residential address"
                      />
                    </FieldBlock>
                    ...
                    <FieldBlock label="Secondary Phone">
                      <Input
                        name="phone2"
                        className="bg-slate-900/50 border-slate-700 text-white placeholder-slate-500 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 h-12 rounded-xl transition-all duration-300"
                        placeholder="Optional alternative number"
                ...
                {/* Section 2: Vehicle Classes */}
                <div className="space-y-8">
                  <SectionHeader number="02" title="Vehicle Classes" subtitle="Select desired license categories" />

                  <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                    {vehicleClasses.map((v) => (
                      <label key={v.id} className="group relative">
                        <div className="absolute inset-0 bg-gradient-to-r from-indigo-500/5 to-purple-600/5 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                        <div className="relative flex items-center gap-4 p-4 bg-slate-900/50 border border-slate-700/50 rounded-xl hover:border-indigo-500/30 hover:shadow-md transition-all duration-300 cursor-pointer">
                          <div className="relative">
                            <input
                              type="checkbox"
                              name={`app_vc_${v.id}`}
                              className="w-5 h-5 rounded-lg border-slate-600 bg-slate-900 text-indigo-500 focus:ring-2 focus:ring-indigo-500/40 focus:ring-offset-0 cursor-pointer"
                            />
                          </div>
                          <div>
                ...
                <div className="grid gap-8 md:grid-cols-2">
                  {/* Medical Section */}
                  <div className="space-y-8">
                    <SectionHeader number="03" title="Medical Details" subtitle="Examination scheduling" tone="emerald" />
                    ...
                    <div className="space-y-6">
                      <FieldBlock label="Medical Date">
                        <Input
                          name="medicalDate"
                          type="date"
                          className="bg-slate-900/50 border-slate-700 text-white focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 h-12 rounded-xl transition-all duration-300"
                        />
                      </FieldBlock>
                      ...
                      <div className="p-4 bg-emerald-500/10 rounded-xl border border-emerald-500/20">
                        <div className="flex items-start gap-3">
                          ...
                          <p className="text-sm text-emerald-300">
                            Selecting a medical date changes application status to{" "}
                            <span className="font-semibold text-amber-400">BOOKED</span>. Otherwise remains{" "}
                            <span className="font-semibold text-blue-400">PENDING</span>.
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  {/* Payment Section */}
                  <div className="space-y-8">
                    <SectionHeader number="04" title="Payment Details" subtitle="Financial information" tone="amber" />

                    <div className="space-y-6">
                      <FieldBlock label="Total Fee" required>
                        <div className="relative">
                          <span className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-500 font-medium">LKR</span>
                          <Input
                            name="totalFee"
                      ...
                      <FieldBlock label="Advance Fee" required>
                        <div className="relative">
                          <span className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-500 font-medium">LKR</span>
                          <Input
                            name="advanceFee"
                      ...
                      <div className="p-4 bg-amber-500/10 rounded-xl border border-amber-500/20">
                        <p className="text-sm text-amber-300">
                          Please ensure payment details are accurately recorded. All
                          financial transactions undergo verification during processing.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                {/* Section 4: Notes */}
                <div className="space-y-8">
                  <SectionHeader number="05" title="Additional Notes" subtitle="Optional remarks or special instructions" tone="slate" />

                  <div className="space-y-3">
                    <Textarea
                      name="notes"
                      className="bg-slate-900/50 border-slate-700 text-white placeholder-slate-500 focus:border-slate-500 focus:ring-1 focus:ring-slate-500 min-h-[120px] rounded-xl transition-all duration-300"
                      placeholder="Enter any additional notes, special requirements, or instructions..."
                    />
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  <Label className="text-slate-300 font-medium">Can drive vehicles</Label>

                  <label className="flex items-center gap-3 p-4 bg-slate-900/50 border border-slate-700/50 rounded-xl hover:border-indigo-500/30 hover:shadow-sm transition-all duration-300 cursor-pointer">
                    <input
                      type="checkbox"
                      name="canDriveVehicles"
                      className="w-5 h-5 rounded-lg border-slate-600 bg-slate-900 text-indigo-500 focus:ring-2 focus:ring-indigo-500/40"
                    />
                ...
                {/* Section 5: Existing License */}
                <div className="space-y-8">
                  <SectionHeader number="06" title="Existing License" subtitle="Current license information (if applicable)" tone="violet" />

                  <div className="space-y-6">
                    <div className="space-y-3">
                      <Label className="text-slate-300 font-medium">
                        Already possess a Driving License?
                      </Label>
                      <div className="w-full md:w-80">
                        <select
                          name="hasExistingLicense"
                          className="w-full bg-slate-900/50 border border-slate-700 text-white rounded-xl p-3 focus:border-violet-500 focus:ring-1 focus:ring-violet-500 transition-all duration-300 cursor-pointer appearance-none bg-[url('data:image/svg+xml;charset=utf-8,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20fill%3D%22none%22%20viewBox%3D%220%200%2020%2020%22%3E%3Cpath%20stroke%3D%22%239CA3AF%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%20stroke-width%3D%221.5%22%20d%3D%22m6%208%204%204%204-4%22%2F%3E%3C%2Fsvg%3E')] bg-no-repeat bg-[right_1rem_center] bg-[length:1.5em_1.5em]"
                          defaultValue="no"
                          onChange={(e) => setHasLicense(e.target.value === "yes")}
                        >
                          <option value="no" className="bg-slate-900 text-white">
                            No, applying for new license
                          </option>
                          <option value="yes" className="bg-slate-900 text-white">
                            Yes, have existing license
                          </option>
                        </select>
                      </div>
                    </div>
                    ...
                    {hasLicense && (
                      <div className="p-8 bg-slate-900/40 rounded-2xl border border-violet-500/20 space-y-8 animate-in fade-in duration-500 shadow-sm">
                        <div className="grid gap-6 md:grid-cols-2">
                          <FieldBlock label="License Number">
                            <Input
                              name="licenseNumber"
                              className="bg-slate-900/50 border-slate-700 text-white placeholder-slate-500 focus:border-violet-500 focus:ring-1 focus:ring-violet-500 h-12 rounded-xl transition-all duration-300"
                              placeholder="Enter license number"
                            />
                          </FieldBlock>
                          ...
                          <FieldBlock label="Issued Date">
                            <Input
                              name="licenseIssuedDate"
                              type="date"
                              className="bg-slate-900/50 border-slate-700 text-white focus:border-violet-500 focus:ring-1 focus:ring-violet-500 h-12 rounded-xl transition-all duration-300"
                            />
                          </FieldBlock>
                        </div>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="grid gap-3 md:grid-cols-2">
                            {vehicleClasses.map((v) => (
                              <label
                                key={v.id}
                                className="flex items-center gap-3 p-3 bg-slate-900/50 border border-slate-700/50 rounded-lg hover:border-violet-500/30 hover:shadow-sm transition-all duration-300 cursor-pointer"
                              >
                                <input
                                  type="checkbox"
                                  name={`lic_vc_${v.id}`}
                                  className="w-4 h-4 rounded border-slate-600 bg-slate-900 text-violet-500 focus:ring-2 focus:ring-violet-500/40"
                                />
                ...
                <div className="pt-8 border-t border-slate-700/50">
                  <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
                    ...
                    <Button
                      disabled={loading}
                      type="submit"
                      className="relative overflow-hidden group bg-indigo-600 hover:bg-indigo-700 text-white font-semibold px-12 py-7 rounded-2xl transition-all duration-500 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed min-w-[240px] transform hover:-translate-y-0.5"
                    >
                      <span className="relative flex items-center gap-3 text-base">
                        {loading ? (
                          <>
          ...
          <div className="absolute bottom-0 left-8 right-8 h-px bg-gradient-to-r from-transparent via-indigo-500/20 to-transparent"></div>
        </div>
      </div>
    </div>
  );
...
function SectionHeader({
  ...
  const toneMap = {
    indigo: "from-indigo-500/10 to-indigo-500/20 border-indigo-500/20 text-indigo-400",
    emerald: "from-emerald-500/10 to-emerald-500/20 border-emerald-500/20 text-emerald-400",
    amber: "from-amber-500/10 to-amber-500/20 border-amber-500/20 text-amber-400",
    slate: "from-slate-500/10 to-slate-500/20 border-slate-500/20 text-slate-300",
    violet: "from-violet-500/10 to-violet-500/20 border-violet-500/20 text-violet-400",
  }[tone];
  ...
  return (
    <div className="flex items-center gap-4">
      <div className="flex-shrink-0">
        <div
          className={`w-10 h-10 rounded-xl bg-gradient-to-br ${toneMap} border flex items-center justify-center`}
        >
